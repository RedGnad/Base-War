...
export const TOY = {
  ...
  /**
   * La rue: la bande de sol qui n'appartient a personne, sur toute la longueur du terrain.
   *
   * La reference peint son sol public en rouge vif sur du vert uni, ce qui est le contraste le
   * plus fort disponible et la raison pour laquelle sa carte se lit d'un coup d'oeil. On lui
   * emprunte le CONTRASTE, pas la teinte: une terre cuite contre le vert du tapis de jeu, pour
   * que la bande se detache sans venir concurrencer le jaune des rampes ni l'or de l'interface.
   */
  street: '#c96f4a',
